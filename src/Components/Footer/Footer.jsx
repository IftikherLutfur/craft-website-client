...
const Footer = () => {
    return (
        <div>
			<hr />
<footer className="px-4 divide-y block bg-zinc-900 text-white">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">Crafty</span>
			</a>
		</div>
	...
	<div className="py-3 text-sm text-center text-white bg-[#1a2535]">© 2024 Develop by Iftikher Lutfur Abdullah.</div>
</footer>            
        </div>
    );
};
